...
def happy_2015():
    ...
    results = db.session.query(Data_2015.country, Data_2015.happiness_rank, Data_2015.happiness_score, \
        Data_2015.gdp_per_capita, Data_2015.family, Data_2015.life_expectancy, Data_2015.freedom, Data_2015.generosity, Data_2015.government_corr).all()
...
def happy_2016():
    results = db.session.query(Data_2016.country, Data_2016.happiness_rank, Data_2016.happiness_score, \
        Data_2016.gdp_per_capita, Data_2016.family, Data_2016.life_expectancy, Data_2016.freedom, Data_2016.generosity, Data_2016.government_corr).all()
...
def happy_2017():
    results = db.session.query(Data_2017.country, Data_2017.happiness_rank, Data_2017.happiness_score, \
        Data_2017.gdp_per_capita, Data_2017.family, Data_2017.life_expectancy, Data_2017.freedom, Data_2017.generosity, Data_2017.government_corr).all()
...
def happy_2018():
    results = db.session.query(Data_2018.country, Data_2018.happiness_rank, Data_2018.happiness_score, \
        Data_2018.gdp_per_capita, Data_2018.social_support, Data_2018.life_expectancy, Data_2018.freedom, Data_2018.generosity, Data_2018.government_corr).all()
...
def happy_2019():
    results = db.session.query(Data_2019.country, Data_2019.happiness_rank, Data_2019.happiness_score, \
        Data_2019.gdp_per_capita, Data_2019.social_support, Data_2019.life_expectancy, Data_2019.freedom, Data_2019.generosity, Data_2019.government_corr).all()
